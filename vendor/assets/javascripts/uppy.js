...
},{"@uppy/aws-s3":36,"@uppy/aws-s3-multipart":17,"@uppy/core":48,"@uppy/drop-target":53,"@uppy/xhr-upload":84}],2:[function(require,module,exports){
...
var MultipartUploader = /*#__PURE__*/function () {
  function MultipartUploader(file, options) {
    ...
    this.lockedCandidatesForBatch = []; // this will cause an infinite loop if it occurs because we will end up
  ...
  _proto._uploadParts = function _uploadParts() {
    ...
    var need = this.options.limit - this.partsInProgress; // e.g. limit of 10, min batch size of 5, 20 parts
    // need 1 is 10
    // need 2 is 5-10
    // need 3 is 5-10
    ...
    if (this.options.batchPartPresign) {
      this._batchPrepareUploadParts(candidates).then(function (result) {
        candidates.forEach(function (index) {
          _this3._uploadPartRetryable(index, result.presignedUrls[index + 1]).then(function () {
            _this3._uploadParts();
          }, function (err) {
            _this3._onError(err);
          });
  ...
  _proto._batchPrepareUploadParts = function _batchPrepareUploadParts(candidates) {
    ...
    return Promise.resolve().then(function () {
      return _this5.options.batchPrepareUploadParts({
        key: _this5.key,
      ...
      var valid = typeof result === 'object' && result && typeof result.presignedUrls === 'object';
  ...
  _proto._uploadPartRetryable = function _uploadPartRetryable(index, presignedUrl) {
    var _this6 = this;

    return this._retryable({
      before: function before() {
        _this6.partsInProgress += 1;
      },
      attempt: function attempt() {
        return _this6._uploadPart(index, presignedUrl);
      },
  ...
  _proto._uploadPart = function _uploadPart(index, presignedUrl) {
    var _this7 = this;
    ...
    return Promise.resolve().then(function () {
      ...
      return _this7.options.prepareUploadPart({
        key: _this7.key,
      ...
      return _this7._uploadPartBytes(index, url, headers);
    });
  };
  ...
  _proto._uploadPartBytes = function _uploadPartBytes(index, url, headers) {
    ...
    xhr.upload.addEventListener('progress', function (ev) {
      ...
      _this8._onPartProgress(index, ev.loaded, ev.total);
    });
    xhr.addEventListener('abort', function (ev) {
      cleanup();
      _this8.chunkState[index].busy = false;
    ...
    xhr.addEventListener('load', function (ev) {
      ...
      _this8._onPartProgress(index, body.size, body.size); // NOTE This must be allowed by CORS.
      ...
      _this8._onPartComplete(index, etag);
  ...
  _proto._completeUpload = function _completeUpload() {
    ...
    return Promise.resolve().then(function () {
      return _this9.options.completeMultipartUpload({
        key: _this9.key,
        uploadId: _this9.uploadId,
        parts: _this9.parts
      });
    }).then(function (result) {
      _this9.options.onSuccess(result);
    }, function (err) {
      _this9._onError(err);
    });
  };
  ...
  _proto._abortUpload = function _abortUpload() {
    ...
    this.createdPromise.then(function () {
      _this10.options.abortMultipartUpload({
        key: _this10.key,
        uploadId: _this10.uploadId
      });
...
},{"@uppy/utils/lib/AbortController":57,"@uppy/utils/lib/delay":63}],17:[function(require,module,exports){
var _class, _temp;
...
module.exports = (_temp = _class = /*#__PURE__*/function (_Plugin) {
  ...
  function AwsS3Multipart(uppy, opts) {
    ...
    var defaultOptions = {
      ...
      batchPrepareUploadParts: _this.batchPrepareUploadParts.bind(_assertThisInitialized(_this)),
  ...
  _proto.batchPrepareUploadParts = function batchPrepareUploadParts(file, _ref3) {
    var key = _ref3.key,
        uploadId = _ref3.uploadId,
        partNumbers = _ref3.partNumbers;
  ...
  _proto.uploadFile = function uploadFile(file) {
    ...
    return new Promise(function (resolve, reject) {
      ...
      var upload = new Uploader(file.data, _extends({
        ...
        batchPrepareUploadParts: _this2.opts.batchPrepareUploadParts.bind(_this2, file),
        ...
        batchPartPresign: _this2.opts.batchPartPresign,
        minNeededForPresignBatch: _this2.opts.minNeededForPresignBatch || _this2.opts.limit || 5,
        onStart: onStart,
...
},{"../package.json":34,"./MultipartUploader":16,"@uppy/companion-client":44,"@uppy/core":20,"@uppy/utils/lib/EventTracker":58,"@uppy/utils/lib/RateLimitedQueue":61,"@uppy/utils/lib/emitSocketProgress":64,"@uppy/utils/lib/getSocketHost":76}],18:[function(require,module,exports){
...
},{"@uppy/utils/lib/findDOMElement":66,"preact":32}],20:[function(require,module,exports){
function _extends() { _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return _extends.apply(this, arguments); }
...
},{"../package.json":23,"./Plugin":19,"./loggers":21,"./supportsUploadProgress":22,"@transloadit/prettier-bytes":18,"@uppy/store-default":24,"@uppy/utils/lib/Translator":62,"@uppy/utils/lib/findIndex":67,"@uppy/utils/lib/generateFileID":68,"@uppy/utils/lib/getFileNameAndExtension":74,"@uppy/utils/lib/getFileType":75,"cuid":25,"lodash.throttle":29,"mime-match":30,"namespace-emitter":31}],21:[function(require,module,exports){
...
},{"@uppy/utils/lib/getTimeStamp":77}],22:[function(require,module,exports){
...
},{"./lib/fingerprint.js":26,"./lib/getRandomValue.js":27,"./lib/pad.js":28,"dup":4}],26:[function(require,module,exports){
arguments[4][5][0].apply(exports,arguments)
},{"./pad.js":28,"dup":5}],27:[function(require,module,exports){
...
},{"dup":9,"wildcard":33}],31:[function(require,module,exports){
...
},{"@uppy/companion-client":44,"@uppy/utils/lib/EventTracker":58,"@uppy/utils/lib/NetworkError":59,"@uppy/utils/lib/ProgressTimeout":60,"@uppy/utils/lib/emitSocketProgress":64,"@uppy/utils/lib/getSocketHost":76,"@uppy/utils/lib/isNetworkError":80,"cuid":4}],36:[function(require,module,exports){
var _class, _temp;
...
},{"../package.json":38,"./MiniXHRUpload":35,"./isXml":37,"@uppy/companion-client":44,"@uppy/core":48,"@uppy/utils/lib/RateLimitedQueue":61,"@uppy/utils/lib/Translator":62,"@uppy/utils/lib/hasProperty":78,"@uppy/utils/lib/settle":82,"qs-stringify":11,"url-parse":14}],37:[function(require,module,exports){
/**
...
},{"./RequestClient":41,"./tokenStorage":45,"qs-stringify":11,"url-parse":14}],41:[function(require,module,exports){
'use strict';
...
},{"../package.json":46,"./AuthError":39,"@uppy/utils/lib/fetchWithNetworkError":65}],42:[function(require,module,exports){
'use strict';
...
},{"./RequestClient":41}],43:[function(require,module,exports){
var ee = require('namespace-emitter');
...
},{"namespace-emitter":10}],44:[function(require,module,exports){
'use strict';
/**
...
},{"./Provider":40,"./RequestClient":41,"./SearchProvider":42,"./Socket":43}],45:[function(require,module,exports){
'use strict';
/**
...
},{"@uppy/utils/lib/findDOMElement":66,"dup":19,"preact":51}],48:[function(require,module,exports){
function _extends() { _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return _extends.apply(this, arguments); }
...
module.exports.Plugin = Plugin;
module.exports.debugLogger = debugLogger;
},{"../package.json":52,"./Plugin":47,"./loggers":49,"./supportsUploadProgress":50,"@transloadit/prettier-bytes":2,"@uppy/store-default":55,"@uppy/utils/lib/Translator":62,"@uppy/utils/lib/findIndex":67,"@uppy/utils/lib/generateFileID":68,"@uppy/utils/lib/getFileNameAndExtension":74,"@uppy/utils/lib/getFileType":75,"cuid":4,"lodash.throttle":8,"mime-match":9,"namespace-emitter":10}],49:[function(require,module,exports){
arguments[4][21][0].apply(exports,arguments)
},{"@uppy/utils/lib/getTimeStamp":77,"dup":21}],50:[function(require,module,exports){
...
},{"../package.json":54,"@uppy/core":48,"@uppy/utils/lib/getDroppedFiles":69,"@uppy/utils/lib/toArray":83}],54:[function(require,module,exports){
module.exports={
...
},{"abortcontroller-polyfill/dist/abortcontroller":3}],58:[function(require,module,exports){
/**
...
},{"./findIndex":67}],62:[function(require,module,exports){
function _extends() { _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return _extends.apply(this, arguments); }
...
},{"./hasProperty":78}],63:[function(require,module,exports){
...
},{"./AbortController":57}],64:[function(require,module,exports){
var throttle = require('lodash.throttle');
...
},{"lodash.throttle":8}],65:[function(require,module,exports){
...
},{"./NetworkError":59}],66:[function(require,module,exports){
...
},{"./isDOMElement":79}],67:[function(require,module,exports){
/**
...
},{"./utils/fallbackApi":70,"./utils/webkitGetAsEntryApi/index":73}],70:[function(require,module,exports){
...
},{"../../toArray":83}],71:[function(require,module,exports){
/**
...
},{"../../../toArray":83,"./getFilesAndDirectoriesFromDirectory":71,"./getRelativePath":72}],74:[function(require,module,exports){
/**
...
},{"./getFileNameAndExtension":74,"./mimeTypes":81}],76:[function(require,module,exports){
...
},{"../package.json":85,"@uppy/companion-client":44,"@uppy/core":48,"@uppy/utils/lib/EventTracker":58,"@uppy/utils/lib/NetworkError":59,"@uppy/utils/lib/ProgressTimeout":60,"@uppy/utils/lib/RateLimitedQueue":61,"@uppy/utils/lib/Translator":62,"@uppy/utils/lib/emitSocketProgress":64,"@uppy/utils/lib/getSocketHost":76,"@uppy/utils/lib/isNetworkError":80,"@uppy/utils/lib/settle":82,"cuid":4}],85:[function(require,module,exports){
module.exports={
