...
task 'javascript:update' => 'clean_up' do
  ...
  dependencies.each do |f|
    ...
    if src.include? "lodash.js"
      ...
      system('yarn run lodash include="each,filter,map,range,first,isEmpty,chain,extend,every,omit,merge,union,sortBy,uniq,intersection,reject,compact,reduce,debounce,throttle,values,pick,keys,flatten,min,max,isArray,delay,isString,isEqual,without,invoke,clone,findIndex,find,groupBy,escapeRegExp" minus="template" -d -o "node_modules/lodash.js"')
    end
